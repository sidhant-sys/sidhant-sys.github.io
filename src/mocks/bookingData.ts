export const bookingData = {
    ...
    "flightBookingResult": {
      "ticketingDeadline": "2025-09-16T21:56:37.456047125",
      "gracePeriod": "6 days",
      "instructions": "Your tickets are confirmed. Enjoy your flight!",
      "note": "Ready for real Amadeus API - requires Gson dependency for JsonObject",
      "pdfDownloadUrl": "/api/pdf/download/flight_booking_CT397455_1757541397457.pdf",
      "totalPrice": {
        "total": "854.07",
        "currency": "USD",
        "base": "413.00"
      },
      "amadeusRequestSize": 5097,
      ...
      "bookingReference": "CT397455",
      "createdAt": "2025-09-10T21:56:37.457076513",
      "paymentRequired": false,
      "bookingType": "CONFIRMED",
      "pdfPath": "booking-pdfs/flight_booking_CT397455_1757541397457.pdf",
      "realApiAttempted": true,
      "pdfViewUrl": "/api/pdf/view/flight_booking_CT397455_1757541397457.pdf",
      "bookingStatus": "CONFIRMED",
      "instantTicketing": true,
      "amadeusError": "[400]\nThis attribute must be a number",
      "pdfGenerated": true,
      "flightOrderId": "AMD1757541397455FL",
      "contactEmail": "booking@cleartrip.com",
      "message": "Flight booking successful - Tickets confirmed and issued",
      "flightOffers": [
        {
          "type": "flight-offer",
          "id": "1",
      ...
      "pnr": "CT397455",
      "pdfFileName": "flight_booking_CT397455_1757541397457.pdf",
    ...
    "hotelBookingResult": {
      "pdfGenerated": true,
      "pdfDownloadUrl": "/api/pdf/download/hotel_booking_PJI1OB_1757541398550.pdf",
      "data": {
        "roomQuantity": 1,
        "policies": {
          "cancellation": {
        ...
        "confirmation": {
          "source": "AMADEUS_API",
          "timestamp": "2025-09-10T21:56:38.550282609Z",
          "status": "CONFIRMED"
        },
        "type": "hotel-booking",
        "rateCode": "RAC",
        "room": {
          ...
          "description": {
            "text": "Standard room with essential amenities and comfortable bedding"
          },
          "type": "STANDARD"
        },
        "roomStatus": "RESERVED",
        ...
        "providerConfirmationId": "PVR98547",
        "guests": [
          {
        ...
        "hotel": {
          "contact": {
            "phone": "+1-555-HOTEL-1",
            "email": "reservations@budgetinnjfk.com"
          },
          "hotelId": "HTL_STANDARD_JFK",
          "address": {
            "lines": [
              "123 Budget Inn JFK Street"
            ],
            "cityName": "Unknown City",
            "countryCode": "XX"
          },
      ...
      "pdfPath": "booking-pdfs/hotel_booking_PJI1OB_1757541398550.pdf",
      "pdfViewUrl": "/api/pdf/view/hotel_booking_PJI1OB_1757541398550.pdf",
      "pdfFileName": "hotel_booking_PJI1OB_1757541398550.pdf",
      "_metadata": {
        "responseGenerated": "2025-09-10T21:56:38.550336211Z",
        "originalOfferId": "MOCK_STANDARD_JFK_793",
        "dataSource": "FALLBACK_SYSTEM",
        "bookingMethod": "GUARANTEE_POLICY"
      }
    },
    "createdAt": "2025-09-10T19:53:40.426",
    "updatedAt": "2025-09-10T21:56:38.621303938",
    "booked": false
  }